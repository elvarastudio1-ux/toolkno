...
import CaseConverterTool from "@/components/tools/widgets/CaseConverterTool";
import { buildToolMetadata, getToolContent } from "@/lib/tools";

export const metadata = buildToolMetadata("case-converter");

export default function CaseConverterPage() {
  const tool = getToolContent("case-converter");

  return (
    <>
      <ToolSchemaScripts slug="case-converter" />
      <ToolLayout
      title={tool.name}
    ...
    >
      ...
      <ToolInfoSections slug="case-converter" />
