...
import RemoveEmojisTool from "@/components/tools/widgets/RemoveEmojisTool";
import { buildToolMetadata, getToolContent } from "@/lib/tools";

export const metadata = buildToolMetadata("remove-emojis");

export default function RemoveEmojisPage() {
  const tool = getToolContent("remove-emojis");

  return (
    <>
      <ToolSchemaScripts slug="remove-emojis" />
      <ToolLayout
      title={tool.name}
    ...
    >
      ...
      <ToolInfoSections slug="remove-emojis" />
