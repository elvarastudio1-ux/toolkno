...
export function generateMetadata() {
  return buildMetadata({
    title: "Free Online Text Tools — Count, Clean, Convert & Compare",
    description:
      "60+ free text tools that work in your browser. Count words, clean lists, convert case, compare text, and more. No signup. Nothing leaves your device."
  });
}
