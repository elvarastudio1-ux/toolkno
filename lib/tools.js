...
export const tools = [
  ...
  { slug: "base64-encoder", name: "Base64 Encoder", description: "Encode plain text into Base64 or Base64URL instantly in your browser", category: "developer", icon: "64", isPaid: false },
  { slug: "base64-decoder", name: "Base64 Decoder", description: "Decode Base64 or Base64URL strings back into readable text instantly", category: "developer", icon: "B=", isPaid: false }
];
...
export const categoryMeta = {
  counters: {
    label: "Counter Tools",
    headline: "Free text counter tools",
    tagline: "Count words, characters, sentences and paragraphs in any text — instantly.",
    intro:
      "Counters are the fastest way to know how long your writing actually is. Whether you're hitting an essay minimum, trimming a tweet, or sizing a meta description, these free counter tools give you the number in real time. Paste your text and the count updates as you type — no signup, no upload."
  },
  case: {
    label: "Case Converters",
    headline: "Free case converter tools",
    tagline: "Switch between UPPER, lower, Title and Sentence case in one click.",
    intro:
      "Case converters fix messy capitalization in seconds. Got a doc in ALL CAPS? A headline that's lowercase? A list of SKUs you need normalized? Pick the case you want and Toolkno does the rest. Free, browser-based, and works on accented characters too."
  },
  remove: {
    label: "Remove & Clean",
    headline: "Free text cleaning tools",
    tagline: "Strip extra spaces, line breaks, duplicates, HTML, emojis and more.",
    intro:
      "Pasted text is rarely clean. PDFs add weird whitespace, web copy comes laced with HTML tags, social exports are full of emojis. These free remove-and-clean tools take messy text and give you exactly the bytes you actually want — no subscription, no signup."
  },
  sort: {
    label: "Sort & Reverse",
    headline: "Free text sorting tools",
    tagline: "Sort lines A-Z, Z-A, or reverse text, words and lines.",
    intro:
      "Sorting and reversing tools turn messy lists into ordered ones in a click. Sort an email export A-Z. Flip a chronological log. Reverse word order for a brainstorm. They all run in your browser, free, with no account."
  },
  split: {
    label: "Split & Join",
    headline: "Free split and join tools",
    tagline: "Break text into lines, words or paragraphs — or merge them back together.",
    intro:
      "Whether you're prepping a CSV import, separating words for vocab study, or joining a list with a custom delimiter, these free tools handle the busywork. Paste, pick your separator, copy the result."
  },
  generators: {
    label: "Generators",
    headline: "Free text generator tools",
    tagline: "Generate placeholder text, random words, sentences and paragraphs.",
    intro:
      "Need filler for a wireframe? Random prompts for a writing sprint? Test data for a form? These free generators produce the right amount of text in one click — and you get fresh output every time you click again."
  },
  analyze: {
    label: "Analyzers",
    headline: "Free text analysis tools",
    tagline: "Compare drafts, check readability, audit keywords and study sentence structure.",
    intro:
      "Analyzers go beyond counting. Compare two drafts side-by-side, check Flesch readability, audit keyword density, or study how your sentences flow. Useful for SEO, writing, editing and content QA — and free for everyone."
  },
  privacy: {
    label: "Privacy & Redaction",
    headline: "Free privacy and redaction tools",
    tagline: "Mask, redact, censor and normalize sensitive text.",
    intro:
      "When sharing screenshots, logs or transcripts, you sometimes need to hide a name, an email or a phone number. These free privacy tools mask, redact and censor specific parts of your text — all in your browser, so nothing is ever uploaded."
  },
  utilities: {
    label: "Text Utilities",
    headline: "Free text utility tools",
    tagline: "Find and replace, randomize, shuffle, tokenize and validate.",
    intro:
      "Quick text utilities that don't fit a single category — from bulk find-and-replace to shuffling list items. All free, all browser-based."
  },
  audio: {
    label: "Audio Tools",
    headline: "Free text-to-speech and speech-to-text tools",
    tagline: "Read text aloud, or dictate text into your browser.",
    intro:
      "Browser-based tools for converting between text and speech. Useful for proofreading, accessibility checks, and quick dictation. Free, no signup, runs entirely in your browser using built-in browser APIs."
  },
  developer: {
    label: "Developer Tools",
    headline: "Free developer text tools",
    tagline: "Encode and decode text in binary, ASCII and more.",
    intro:
      "Developer-focused converters for working with text at the byte level. Convert text to binary, ASCII, or back. Great for teaching, debugging and puzzle building. Free, browser-based."
  }
};
...
export function getToolsByCategory(category) {
  ...
  return tools.filter((tool) => normalizeCategorySlug(tool.category) === normalizedCategory);
}

export function getAllCategorySlugs() {
  return [...new Set(tools.map((tool) => normalizeCategorySlug(tool.category)))].sort();
}
...
function buildSeoDescriptionText(tool) {
  const action = tool.description.toLowerCase().replace(/\.$/, "");
  return `${tool.name} is a free, browser-based tool that helps you ${action}. Paste your text, get the result, copy it. No signup, no upload, nothing stored.`;
}

function buildWhatIsText(tool) {
  const action = tool.description.toLowerCase().replace(/\.$/, "");
  return `${tool.name} is a small, focused tool that helps you ${action} — right in your browser.\n\nPaste your text, see the result instantly, and copy what you need. There's no account to create and your text never leaves your device.`;
}

function buildHowToUse(tool) {
  return [
    `Paste or type your text into the input box.`,
    `Adjust any options on the page if you want a different result.`,
    `The output updates instantly — no "Run" button to click.`,
    `Hit Copy to grab the result, or clear the box to start over.`
  ];
}
  ...
  return [
    {
      ...
      answer: `Yes. Every tool on Toolkno is free, with no signup, no daily limit, and no email wall.`
    },
    {
      question: `Does my text get uploaded anywhere?`,
      answer: `No. ${tool.name} runs entirely in your browser. Nothing is sent to a server or stored.`
    },
    {
      question: `Does it work on mobile?`,
      answer: `Yes — it works the same on phone, tablet, and desktop.`
    }
  ];
}
...
const contextualToolMap = {
  "word-counter": ["character-counter", "sentence-counter", "readability-checker"],
  "character-counter": ["word-counter", "sentence-counter", "text-validator"],
  "sentence-counter": ["word-counter", "paragraph-counter", "readability-checker"],
  "paragraph-counter": ["word-counter", "sentence-counter", "paragraph-splitter"],
  "case-converter": ["text-to-uppercase-converter", "text-to-lowercase-converter", "title-case-converter"],
  "text-to-uppercase-converter": ["case-converter", "text-to-lowercase-converter", "toggle-case-converter"],
  "text-to-lowercase-converter": ["case-converter", "text-to-uppercase-converter", "title-case-converter"],
  "title-case-converter": ["case-converter", "sentence-case-converter", "toggle-case-converter"],
  "sentence-case-converter": ["case-converter", "title-case-converter", "toggle-case-converter"],
  "toggle-case-converter": ["case-converter", "text-to-uppercase-converter", "text-to-lowercase-converter"],
  "remove-html-tags": ["remove-extra-spaces", "find-and-replace-text", "text-validator"],
  "remove-extra-spaces": ["remove-line-breaks", "remove-html-tags", "text-validator"],
  "remove-line-breaks": ["combine-text-lines", "remove-extra-spaces", "text-joiner"],
  "remove-duplicate-lines": ["text-sorter-a-z", "shuffle-text-lines", "line-splitter"],
  "remove-urls-from-text": ["remove-email-addresses-from-text", "remove-extra-spaces", "text-redaction-tool"],
  "remove-email-addresses-from-text": ["text-redaction-tool", "text-masking-tool", "remove-urls-from-text"],
  "text-sorter-a-z": ["text-sorter-z-a", "remove-duplicate-lines", "shuffle-text-lines"],
  "text-sorter-z-a": ["text-sorter-a-z", "reverse-lines", "shuffle-text-lines"],
  "reverse-text": ["reverse-words", "reverse-lines", "text-randomizer"],
  "reverse-words": ["reverse-text", "word-splitter", "text-randomizer"],
  "reverse-lines": ["line-splitter", "text-sorter-z-a", "shuffle-text-lines"],
  "text-splitter": ["word-splitter", "line-splitter", "text-joiner"],
  "line-splitter": ["text-splitter", "combine-text-lines", "reverse-lines"],
  "word-splitter": ["text-splitter", "text-tokenizer", "text-joiner"],
  "paragraph-splitter": ["paragraph-counter", "combine-text-lines", "text-joiner"],
  "combine-text-lines": ["text-joiner", "remove-line-breaks", "line-splitter"],
  "text-joiner": ["combine-text-lines", "text-splitter", "word-splitter"],
  "lorem-ipsum-generator": ["random-sentence-generator", "random-paragraph-generator", "word-counter"],
  "random-word-generator": ["random-sentence-generator", "text-randomizer", "word-splitter"],
  "random-sentence-generator": ["random-paragraph-generator", "lorem-ipsum-generator", "readability-checker"],
  "random-paragraph-generator": ["lorem-ipsum-generator", "random-sentence-generator", "word-counter"],
  "prefix-suffix-text-generator": ["find-and-replace-text", "text-joiner", "line-splitter"],
  "text-compare-tool": ["text-difference-checker", "case-sensitive-compare", "case-insensitive-compare"],
  "text-difference-checker": ["text-compare-tool", "case-sensitive-compare", "case-insensitive-compare"],
  "case-sensitive-compare": ["text-compare-tool", "case-insensitive-compare", "text-difference-checker"],
  "case-insensitive-compare": ["text-compare-tool", "case-sensitive-compare", "text-difference-checker"],
  "keyword-density-checker": ["stop-word-counter", "word-counter", "readability-checker"],
  "stop-word-counter": ["keyword-density-checker", "word-counter", "text-tokenizer"],
  "readability-checker": ["sentence-analyzer", "word-counter", "text-complexity-analyzer"],
  "sentence-analyzer": ["readability-checker", "sentence-counter", "text-complexity-analyzer"],
  "text-complexity-analyzer": ["readability-checker", "sentence-analyzer", "keyword-density-checker"],
  "text-masking-tool": ["text-redaction-tool", "censor-text-tool", "remove-email-addresses-from-text"],
  "text-redaction-tool": ["text-masking-tool", "censor-text-tool", "remove-email-addresses-from-text"],
  "censor-text-tool": ["text-redaction-tool", "text-masking-tool", "find-and-replace-text"],
  "normalize-unicode-text": ["remove-accents", "text-validator", "find-and-replace-text"],
  "find-and-replace-text": ["text-validator", "remove-extra-spaces", "prefix-suffix-text-generator"],
  "text-randomizer": ["shuffle-text-lines", "random-word-generator", "reverse-words"],
  "shuffle-text-lines": ["text-randomizer", "remove-duplicate-lines", "reverse-lines"],
  "text-tokenizer": ["word-splitter", "stop-word-counter", "text-validator"],
  "text-validator": ["find-and-replace-text", "normalize-unicode-text", "remove-extra-spaces"],
  "text-to-speech": ["speech-to-text", "readability-checker", "word-counter"],
  "speech-to-text": ["text-to-speech", "word-counter", "find-and-replace-text"],
  "text-to-binary-converter": ["binary-to-text-converter", "text-to-ascii-converter", "text-validator"],
  "binary-to-text-converter": ["text-to-binary-converter", "text-to-ascii-converter", "text-validator"],
  "text-to-ascii-converter": ["text-to-binary-converter", "binary-to-text-converter", "text-validator"]
  ,
  "base64-encoder": ["base64-decoder", "text-to-binary-converter", "text-to-ascii-converter"],
  "base64-decoder": ["base64-encoder", "binary-to-text-converter", "text-validator"]
};

function getDefaultContextualSlugs(tool) {
  const defaultsByCategory = {
    counters: ["character-counter", "sentence-counter", "readability-checker"],
    case: ["case-converter", "title-case-converter", "sentence-case-converter"],
    remove: ["remove-extra-spaces", "find-and-replace-text", "text-validator"],
    sort: ["text-sorter-a-z", "reverse-lines", "shuffle-text-lines"],
    split: ["text-splitter", "combine-text-lines", "text-joiner"],
    generators: ["lorem-ipsum-generator", "random-sentence-generator", "random-paragraph-generator"],
    analyze: ["word-counter", "readability-checker", "text-compare-tool"],
    privacy: ["text-redaction-tool", "text-masking-tool", "remove-email-addresses-from-text"],
    utilities: ["find-and-replace-text", "text-tokenizer", "text-validator"],
    audio: ["text-to-speech", "speech-to-text", "word-counter"],
    developer: ["text-to-binary-converter", "binary-to-text-converter", "text-to-ascii-converter"]
  };

  return defaultsByCategory[tool.category] || [];
}

export function getContextualToolSlugs(slug, limit = 3) {
  const tool = getToolBySlug(slug);
  if (!tool) return [];

  const ordered = [
    ...(contextualToolMap[slug] || []),
    ...getDefaultContextualSlugs(tool),
    ...getRelatedToolSlugs(slug)
  ];

  const unique = [];
  for (const candidateSlug of ordered) {
    if (!candidateSlug || candidateSlug === slug || unique.includes(candidateSlug)) continue;
    if (getToolBySlug(candidateSlug)) unique.push(candidateSlug);
...
export function getContextualTools(slug, limit = 3) {
  return getContextualToolSlugs(slug, limit)
...
const slugContentOverrides = {
  "word-counter": {
    ...
    example: {
      caption: "A short blog intro becomes 8 stats in real time.",
      input: "Toolkno is a free, browser-based toolbox. Paste your text. Get the count. Move on.",
      output: "Words: 14\nCharacters: 82\nCharacters (no spaces): 70\nSentences: 4\nParagraphs: 1\nReading time: ~6 sec\nUnique words: 13"
    },
    benefits: [
      "Hit blog post or essay targets without scrolling and counting in your head.",
      "See reading time so you know how long your post takes to read.",
      "Spot repetition with the unique-word count.",
      "Works offline once the page loads — your text never gets uploaded."
    ],
    faqs: [
      {
  ...
  "character-counter": {
    ...
    example: {
      caption: "See your character count update in real time.",
      input: "Free text tools that just work.",
      output: "Characters: 31\nCharacters (no spaces): 26\nWords: 6\nLines: 1"
    },
    benefits: [
      "Stay under tweet, SMS and meta description limits without guessing.",
      "See spaces-included and spaces-excluded counts side by side.",
      "Updates as you type — no ‘Calculate’ button.",
      "Runs in your browser, so private text stays private."
    ],
    faqs: [
  ...
  "sentence-counter": {
    ...
    example: {
      caption: "A short paragraph broken into sentence stats.",
      input: "Toolkno is fast. It's free. No signup. Try it.",
      output: "Sentences: 4\nAverage length: 2.5 words\nLongest: 3 words\nShortest: 2 words"
    },
    benefits: [
      "Hit essay or assignment minimums without manually counting.",
      "Spot one-sentence paragraphs that need expansion.",
      "Catch run-ons before publishing or submitting.",
      "Compare drafts to see how your editing tightened structure."
    ],
    faqs: [
  ...
  "paragraph-counter": {
    ...
    example: {
      caption: "Two short paragraphs become a clear count.",
      input: "Toolkno is small and fast.\n\nIt does one job per tool, well.",
      output: "Paragraphs: 2\nLines: 3\nWords: 11"
    },
    benefits: [
      "Track structure on long-form drafts at a glance.",
      "Spot walls of text that need a paragraph break.",
      "Confirm chapter or page targets before submitting.",
      "Works on essays, blog posts, books and reports."
    ],
    faqs: [
  ...
  "case-converter": {
    ...
    example: {
      caption: "One messy line, four clean cases.",
      input: "hELLO worLD from TOOLKNO",
      output: "UPPER: HELLO WORLD FROM TOOLKNO\nlower: hello world from toolkno\nTitle: Hello World From Toolkno\nSentence: Hello world from toolkno"
    },
    benefits: [
      "Switch between four common cases in one click.",
      "Fix client copy that came in shouty caps or random caps.",
      "Keep headlines consistent across your blog and CMS.",
      "Normalize SKUs, slugs and database fields fast."
    ],
    faqs: [
  ...
  "text-to-uppercase-converter": {
    ...
    example: {
      caption: "Plain text becomes a clean uppercase headline.",
      input: "new pricing plans now live",
      output: "NEW PRICING PLANS NOW LIVE"
    },
    benefits: [
      "Generate stand-out headings and labels in one click.",
      "Normalize SKUs and product codes for clean imports.",
      "Keep numbers, symbols and line breaks intact.",
      "Works on accented characters too (café → CAFÉ)."
    ],
    faqs: [
  ...
  "text-to-lowercase-converter": {
    ...
    example: {
      caption: "Shouty text becomes a clean lowercase line.",
      input: "HELLO@TOOLKNO.COM",
      output: "hello@toolkno.com"
    },
    benefits: [
      "Fix accidental Caps Lock without retyping.",
      "Normalize emails before saving to a database (no duplicate accounts).",
      "Clean up shouty hashtags or social copy.",
      "Make URL slugs consistent across your site."
    ],
    faqs: [
  ...
  "title-case-converter": {
    ...
    example: {
      caption: "Sentence becomes a clean blog title.",
      input: "how to write better headlines in 5 minutes",
      output: "How to Write Better Headlines in 5 Minutes"
    },
    benefits: [
  ...
  "sentence-case-converter": {
    ...
    example: {
      caption: "Title-cased text becomes friendly sentence case.",
      input: "How To Write Better Headlines In 5 Minutes",
      output: "How to write better headlines in 5 minutes"
    },
    benefits: [
      "Modernize headlines from old-school Title Case to clean sentence case.",
      "Match the tone most modern apps and SaaS UIs use.",
      "Convert multiple sentences — each first word capitalizes correctly.",
      "Pairs well with the Title Case tool for quick voice swaps."
    ],
    faqs: [
  ...
  "toggle-case-converter": {
    ...
    example: {
      caption: "Reverse-case text gets fixed in one click.",
      input: "hELLO wORLD",
      output: "Hello World"
    },
    benefits: [
      "Recover from accidental Caps Lock without retyping.",
      "Flip every uppercase letter and every lowercase letter at once.",
      "Run twice and you get the original back — great for undo testing.",
      "Works on accented letters too (á ↔ Á)."
    ],
    faqs: [
  ...
  "remove-extra-spaces": {
    ...
    example: {
      caption: "Messy spacing becomes clean, single-spaced text.",
      input: "  Hello   world,    this   is   Toolkno.  ",
      output: "Hello world, this is Toolkno."
    },
    benefits: [
  ...
  "remove-line-breaks": {
    ...
    example: {
      caption: "Broken PDF paste becomes one clean paragraph.",
      input: "Toolkno is a fast,\nbrowser-based\ntoolbox.",
      output: "Toolkno is a fast, browser-based toolbox."
    },
    benefits: [
      "Reflow text copied from PDFs or emails into clean prose.",
      "Toggle to keep blank lines as paragraph breaks.",
      "Handles both Windows (\\r\\n) and Unix (\\n) line endings.",
      "Pairs well with Remove Extra Spaces for total whitespace cleanup."
    ],
    faqs: [
  ...
  "remove-duplicate-lines": {
    ...
    example: {
      caption: "A messy email list becomes a unique one.",
      input: "alice@x.com\nbob@x.com\nalice@x.com\ncarol@x.com\nbob@x.com",
      output: "alice@x.com\nbob@x.com\ncarol@x.com"
    },
    benefits: [
      "Dedupe email lists, slugs, SKUs or any line-based list in one click.",
      "Keeps original order — first occurrence wins.",
      "Toggle case sensitivity for emails or codes.",
      "Works on tens of thousands of lines without slowing your tab."
    ],
    faqs: [
  ...
  "remove-special-characters": {
    ...
    example: {
      caption: "Symbols and weird Unicode get stripped.",
      input: "Café #1 — best place! @ToolknoHQ",
      output: "Caf 1  best place ToolknoHQ"
    },
    benefits: [
  ...
  "remove-numbers-from-text": {
    ...
    example: {
      caption: "Numbers and digits stripped from any text.",
      input: "In 2024 Toolkno launched 60 free tools.",
      output: "In  Toolkno launched  free tools."
    },
    benefits: [
  ...
  "remove-punctuation": {
    ...
    example: {
      caption: "All punctuation gets stripped in one pass.",
      input: "Hello, world! Don't forget: Toolkno's free.",
      output: "Hello world Dont forget Toolknos free"
    },
    benefits: [
  ...
  "remove-emojis": {
    ...
    example: {
      caption: "Emojis stripped while words stay intact.",
      input: "Toolkno is 🔥 fast 🚀 and free ✨",
      output: "Toolkno is  fast  and free "
    },
    benefits: [
      "Clean social exports and customer feedback for B2B reports.",
      "Avoid 4-byte UTF-8 errors in legacy SQL databases.",
      "Catches Unicode 15+ ranges including ZWJ family emojis.",
      "Keeps math and currency symbols (∑, €) untouched."
    ],
    faqs: [
  ...
  "remove-html-tags": {
    ...
    example: {
      caption: "HTML markup becomes plain readable text.",
      input: "<p>Hello <b>world</b> from <a href='/'>Toolkno</a>.</p>",
      output: "Hello world from Toolkno."
    },
    benefits: [
  ...
  "remove-urls-from-text": {
    ...
    example: {
      caption: "Inline links removed cleanly.",
      input: "Visit https://toolkno.com or http://example.com for free tools.",
      output: "Visit  or  for free tools."
    },
    benefits: [
  ...
  "remove-email-addresses-from-text": {
    ...
    example: {
      caption: "Email addresses stripped for safe sharing.",
      input: "Contact alice@toolkno.com or bob+team@example.org for help.",
      output: "Contact  or  for help."
    },
    benefits: [
  ...
  "remove-accents": {
    ...
    example: {
      caption: "Accented characters become plain ASCII letters.",
      input: "café à Périgueux — jalapeño, näivé, naïve",
      output: "cafe a Perigueux — jalapeno, naive, naive"
    },
    benefits: [
  ...
  "normalize-unicode-text": {
    ...
    example: {
      caption: "Decomposed Unicode normalized to clean NFC.",
      input: "café (decomposed: cafe\u0301)",
      output: "café (NFC: 4 codepoints)"
    },
    benefits: [
      "Fix 'café != café' string equality bugs in JS, Python and Go.",
      "Keep search and indexing matches consistent.",
      "NFKC mode normalizes full-width CJK to ASCII (０１２ → 012).",
  ...
  "text-masking-tool": {
    ...
    example: {
      caption: "Credit card with last 4 visible.",
      input: "4111 2222 3333 4444",
      output: "**** **** **** 4444"
    },
    benefits: [
      "Hide credentials and IDs in screenshots before sharing.",
      "Preserve string length so log line widths stay aligned.",
      "Pick asterisks, X or any single character as the mask.",
      "Show the last 4 digits for credit-card-style receipts."
    ],
    faqs: [
  ...
  "text-redaction-tool": {
    ...
    example: {
      caption: "Names redacted for FOIA-style sharing.",
      input: "Dr. Jane Smith met with John Doe on Monday.\nRedact: Jane Smith, John Doe",
      output: "Dr. [REDACTED] met with [REDACTED] on Monday."
    },
    benefits: [
      "Replace sensitive phrases with [REDACTED] markers in one click.",
      "Catches every occurrence of each phrase — no misses.",
      "Choose between solid blocks (███) or [REDACTED] text.",
      "Save your redaction list as the audit key for your case file."
    ],
    faqs: [
  ...
  "censor-text-tool": {
    ...
    example: {
      caption: "Banned words bleeped while structure stays.",
      input: "This is a damn good tool.\nWord list: damn",
      output: "This is a **** good tool."
    },
    benefits: [
      "Keep forums and broadcasts safe-for-work without rewriting.",
      "Length-preserving asterisks keep subtitle timing intact.",
      "Use word-boundary mode to avoid Scunthorpe-style false positives.",
      "Censor multi-word phrases as one unit."
    ],
    faqs: [
  ...
  "text-sorter-a-z": {
    ...
    example: {
      caption: "A messy list becomes a clean A-Z one.",
      input: "Toolkno\nApple\nzebra\nbanana\nCarrot",
      output: "Apple\nbanana\nCarrot\nToolkno\nzebra"
    },
    benefits: [
      "Alphabetize names, keywords or bibliography entries in one click.",
      "Toggle case sensitivity for typical user expectations.",
      "Locale-aware mode keeps accented letters near their base letter.",
      "Pairs with Remove Duplicate Lines for clean unique sorted lists."
    ],
    faqs: [
  ...
  "text-sorter-z-a": {
    ...
    example: {
      caption: "Same list, sorted Z to A.",
      input: "Apple\nbanana\nCarrot\nToolkno\nzebra",
      output: "zebra\nToolkno\nCarrot\nbanana\nApple"
    },
    benefits: [
      "Surface late-alphabet inventory or clearance SKUs first.",
      "Reverse a sort without manually flipping rows.",
      "Toggle case sensitivity to match your needs.",
      "Locale-aware mode for international content."
    ],
    faqs: [
  ...
  "reverse-text": {
    ...
    example: {
      caption: "Any string flipped character by character.",
      input: "Toolkno is fast",
      output: "tsaf si onkllooT"
    },
    benefits: [
  ...
  "reverse-words": {
    ...
    example: {
      caption: "Word order flipped while spelling stays intact.",
      input: "Toolkno is fast and free",
      output: "free and fast is Toolkno"
    },
    benefits: [
      "Test poetry rhythm and find punchier line endings.",
      "Brainstorm tagline alternatives instantly.",
      "Spelling stays intact — only word order changes.",
      "Use line-by-line mode to keep stanzas separate."
    ],
    faqs: [
  ...
  "reverse-lines": {
    ...
    example: {
      caption: "Newest-first log becomes oldest-first.",
      input: "3:02 error\n3:01 retry\n3:00 connect",
      output: "3:00 connect\n3:01 retry\n3:02 error"
    },
    benefits: [
  ...
  "combine-text-lines": {
    ...
    example: {
      caption: "A column of values becomes a SQL IN-clause.",
      input: "101\n102\n103",
      output: "'101','102','103'"
    },
    benefits: [
  ...
  "shuffle-text-lines": {
    ...
    example: {
      caption: "A list shuffled with provably fair Fisher-Yates.",
      input: "Apple\nBanana\nCarrot\nDate\nElderberry",
      output: "Carrot\nElderberry\nApple\nDate\nBanana"
    },
    benefits: [
  ...
  "text-randomizer": {
    ...
    example: {
      caption: "Sentence words shuffled into chaos.",
      input: "Toolkno is fast and free for everyone.",
      output: "free Toolkno everyone for and is fast."
    },
    benefits: [
      "Generate fuzz-test inputs for parsers and NLP services.",
      "Spark new sentence ideas when stuck on a draft.",
      "Toggle sentence-bounded mode for gentler shuffling.",
      "New result every click — generate 10 and pick the best."
    ],
    faqs: [
  ...
  "text-tokenizer": {
    ...
    example: {
      caption: "Short prompt sized in tokens.",
  ...
  "find-and-replace-text": {
    ...
    example: {
      caption: "Bulk-replace a brand name everywhere in one pass.",
      input: "OldBrand makes great tools. OldBrand is fast.\nFind: OldBrand  →  Replace: NewBrand",
      output: "NewBrand makes great tools. NewBrand is fast.\n2 replacements made."
    },
    benefits: [
      "Rename a product or term across long docs without scrolling.",
      "Fix the same typo in 50 places in one click.",
      "Toggle case-sensitive or whole-word matching.",
      "See a count of every replacement made for verification."
    ],
    faqs: [
  ...
  "text-splitter": {
    ...
    example: {
      caption: "A comma-delimited string becomes a clean list.",
      input: "alice,bob,carol,dave",
      output: "alice\nbob\ncarol\ndave"
    },
    benefits: [
  ...
  "line-splitter": {
    ...
    example: {
      caption: "Plain lines get numbered for easy reference.",
      input: "first line\nsecond line\nthird line",
      output: "1: first line\n2: second line\n3: third line"
    },
    benefits: [
  ...
  "word-splitter": {
    ...
    example: {
      caption: "Sentence broken into one word per line.",
      input: "Toolkno is small and fast.",
      output: "Toolkno\nis\nsmall\nand\nfast"
    },
    benefits: [
  ...
  "paragraph-splitter": {
    ...
    example: {
      caption: "Long text becomes labeled paragraph blocks.",
      input: "First paragraph here.\n\nSecond paragraph here.\n\nThird paragraph here.",
      output: "¶ 1: First paragraph here.\n¶ 2: Second paragraph here.\n¶ 3: Third paragraph here."
    },
    benefits: [
      "Reference paragraphs precisely in editorial feedback.",
      "Reorder structural blocks without losing position.",
      "Compare competitor posts paragraph by paragraph.",
      "Inline formatting (italics, HTML) stays intact."
    ],
    faqs: [
  ...
  "text-joiner": {
    ...
    example: {
      caption: "Lines joined with a regex-friendly pipe.",
      input: "foo\nbar\nbaz",
      output: "foo|bar|baz"
    },
    benefits: [
  ...
  "lorem-ipsum-generator": {
    ...
    example: {
      caption: "Two sentences of placeholder text generated instantly.",
      input: "Sentences: 2",
    ...
    benefits: [
      "Fill mockups and wireframes with realistic placeholder text.",
      "Generate by words, sentences or paragraphs — your choice.",
      "Avoid copyrighted strings when seeding component library docs.",
      "Click again for fresh randomized output every time."
    ],
    faqs: [
  ...
  "random-word-generator": {
    ...
    example: {
      caption: "A fresh batch of 5 random words.",
      input: "Count: 5",
      output: "orbit\nlantern\ncrisp\nember\nsignal"
    },
    benefits: [
      "Break out of vocabulary habits during ideation sprints.",
      "Generate unbiased prompts for word games and writing.",
      "Seed product naming brainstorms with fresh material.",
      "Click again for a brand new batch every time."
    ],
    faqs: [
  ...
  "random-sentence-generator": {
    ...
    example: {
      caption: "A few grammatical random sentences.",
      input: "Count: 2",
      output: "The lantern swayed in the autumn breeze.\nQuiet rivers carry the loudest stories."
    },
    benefits: [
      "Generate writing prompts that aren't from a textbook.",
      "Stress-test chatbot NLU handlers with varied input.",
      "Build chatbot test fixtures or NPC dialogue fast.",
      "Mix declarative, question and dialogue modes for variety."
    ],
    faqs: [
  ...
  "random-paragraph-generator": {
    ...
    example: {
      caption: "One realistic English paragraph for layout testing.",
      input: "Paragraphs: 1",
      output: "The afternoon light shifted as commuters crossed the bridge in steady rhythm. Toolkno had spent weeks tightening every detail, and the work was finally beginning to show."
    },
    benefits: [
      "Reveal hyphenation, widow and orphan issues that Lorem hides.",
      "Stress-test responsive breakpoints with realistic content.",
      "Validate typography across font weights and sizes.",
      "Pick from academic, journalistic or chat presets."
    ],
    faqs: [
  ...
  "prefix-suffix-text-generator": {
    ...
    example: {
      caption: "Bare list wrapped with prefix and suffix.",
      input: "toolkno.com\nexample.com\nmysite.com\nPrefix: https://  Suffix: /api",
      output: "https://toolkno.com/api\nhttps://example.com/api\nhttps://mysite.com/api"
    },
    benefits: [
  ...
  "text-difference-checker": {
    ...
    example: {
      caption: "Two drafts produce a clean written change-log.",
      input: "Original: Toolkno is fast and free.\nRevised: Toolkno is fast, free and private.",
      output: "Added: ', free and private'\nRemoved: ' and free'\n1 phrase added, 1 removed."
    },
    benefits: [
      "Get a written change-log instead of just visual highlights.",
      "Toggle word, phrase or sentence-level granularity.",
      "Plain-text output ready to drop into emails or PRs.",
      "Pairs with Text Compare for visual + written review."
    ],
    faqs: [
  ...
  "case-sensitive-compare": {
    ...
    example: {
      caption: "Two API keys checked with strict case matching.",
      input: "A: sk_live_AbCdEf123\nB: sk_live_abcdef123",
      output: "MISMATCH at index 8 ('A' vs 'a')"
    },
    benefits: [
  ...
  "case-insensitive-compare": {
    ...
    example: {
      caption: "Two emails compared without case noise.",
      input: "A: Alice@Toolkno.com\nB: alice@toolkno.com",
      output: "MATCH (case ignored)"
    },
    benefits: [
  ...
  "keyword-density-checker": {
    ...
    example: {
      caption: "Top keywords from a short article.",
      input: "Toolkno makes free text tools. Toolkno is fast. Free text tools save time.",
      output: "toolkno: 2 (15.4%)\nfree: 2 (15.4%)\ntext: 2 (15.4%)\ntools: 2 (15.4%)"
    },
    benefits: [
      "Hit the 1–2% sweet spot without over-optimizing.",
      "Compare your draft to a competitor's natural distribution.",
      "Stop words filtered automatically so real keywords surface.",
      "Toggle bigram or trigram mode for long-tail audits."
    ],
    faqs: [
  ...
  "stop-word-counter": {
    ...
    example: {
      caption: "Filler words counted in a sample paragraph.",
      input: "The cat is on the mat and the dog is in the yard.",
      output: "Stop words: 8 of 13 (61.5%)\n'the' ×4, 'is' ×2, 'on', 'and', 'in'"
    },
    benefits: [
      "Spot bloat in your prose with hard numbers.",
      "Lower stop-word ratios raise keyword density for SEO.",
      "Updates live as you edit — watch your ratio drop.",
      "Pair with Keyword Density Checker for full SEO copy audit."
    ],
    faqs: [
  ...
  "readability-checker": {
    ...
    example: {
      caption: "A complex sentence vs a plain one.",
      input: "The utilization of complicated terminology disincentivizes comprehension.",
      output: "Flesch score: 9 (Very hard)\nGrade level: 17\nSuggestion: shorten and simplify."
    },
    benefits: [
      "See your Flesch score and grade level instantly.",
      "Match Google's preference for readable, accessible content.",
      "Catch jargon and long sentences before publishing.",
      "Edit live and watch the score improve as you simplify."
    ],
    faqs: [
  ...
  "sentence-analyzer": {
    ...
    example: {
      caption: "Sentence stats from a short paragraph.",
      input: "Toolkno is fast. It works in your browser without any signup or upload, which keeps your text private.",
      output: "Sentences: 2\nAverage length: 11 words\nLongest: 18 words\nShortest: 3 words"
    },
    benefits: [
      "Find run-ons by spotting your longest sentence first.",
      "Confirm short-sentence pacing for mobile-friendly web copy.",
      "Compare drafts to see how editing tightened rhythm.",
      "Pairs with Readability Checker for grade-level context."
    ],
    faqs: [
  ...
  "text-complexity-analyzer": {
    ...
    example: {
      caption: "Complexity breakdown for a short marketing line.",
      input: "Toolkno gives you free text tools that just work.",
      output: "Vocabulary uniqueness: 100%\nAvg syllables per word: 1.2\nAvg sentence length: 9 words\nComplexity: low (good for marketing)"
    },
    benefits: [
      "See vocabulary, syntax and structural depth separately.",
      "Tune brand voice for academic, B2B or marketing audiences.",
      "Watch each metric shift independently as you edit.",
      "Pair with Readability Checker for the complete picture."
    ],
    faqs: [
  ...
  "text-validator": {
    ...
    example: {
      caption: "Email format checked against a regex rule.",
      input: "alice@toolkno.com\nbob@\ncarol@example.org\nRule: valid email",
      output: "✓ alice@toolkno.com\n✗ bob@ (invalid format)\n✓ carol@example.org"
    },
    benefits: [
  ...
  "text-to-speech": {
    ...
    example: {
      caption: "Any text becomes spoken audio in your browser.",
      input: "Toolkno makes free text tools.",
      output: "🔊 Plays as spoken audio (browser TTS, no upload)"
    },
    benefits: [
      "Catch awkward phrasing your eyes glide over by hearing your draft.",
      "Adjust speed up to 1.5–2x to review long drafts faster.",
      "Helpful for dyslexia, vision difficulties or hands-free studying.",
  ...
  "speech-to-text": {
    ...
    example: {
      caption: "Voice input becomes written text instantly.",
      input: "🎙️ You say: 'Toolkno makes free text tools'",
      output: "Toolkno makes free text tools."
    },
    benefits: [
      "Dictate first drafts ~2x faster than typing.",
      "Capture quick notes hands-free while reviewing other content.",
      "Bypass typing entirely for accessibility needs.",
      "Most major languages supported — pick before recording."
    ],
    faqs: [
  ...
  "text-to-binary-converter": {
    ...
    example: {
      caption: "A 2-letter word becomes its 8-bit binary.",
      input: "Hi",
      output: "01001000 01101001"
    },
    benefits: [
      "Teach or learn how characters map to ASCII binary.",
      "Encode hints for escape rooms or puzzle games.",
      "Verify character-level encoding when debugging.",
      "Round-trip with the Binary to Text tool to check accuracy."
    ],
    faqs: [
  ...
  "binary-to-text-converter": {
    ...
    example: {
      caption: "A space-separated binary string becomes a real word.",
      input: "01001000 01101001",
      output: "Hi"
    },
    benefits: [
      "Decode binary clues from puzzles or homework instantly.",
      "Verify what bytes a string represents when debugging.",
      "Pairs perfectly with Text to Binary for round-trip testing.",
      "Works on any 8-bit space-separated binary input."
    ],
    faqs: [
  ...
  "text-to-ascii-converter": {
    ...
    example: {
      caption: "Each character mapped to its decimal ASCII code.",
      input: "Hi!",
      output: "H = 72\ni = 105\n! = 33"
    },
    benefits: [
...
export function getToolContent(slug) {
  ...
  return {
    ...
    contextualTools: getContextualTools(slug)
  };
}

const slugSeoOverrides = {
  "word-counter": {
    title: "Free Word Counter — Count Words & Characters | Toolkno",
    description: "Free word counter that shows words, characters, sentences, paragraphs and reading time as you type. No signup. Works in your browser.",
    keywords: ["word counter", "free word counter", "online word counter", "count words"]
  },
  "character-counter": {
    title: "Free Character Counter — With & Without Spaces | Toolkno",
    description: "Count characters instantly, with or without spaces. Perfect for tweets, SMS, meta descriptions and Instagram captions. Free, no signup.",
    keywords: ["character counter", "letter counter", "meta description length", "tweet character count"]
  },
  "sentence-counter": {
    title: "Free Sentence Counter — Count Sentences Online | Toolkno",
    description: "Count sentences in essays, blog posts, emails or any text. Free online sentence counter — paste your text and see the count instantly.",
    keywords: ["sentence counter", "count sentences", "sentence count tool"]
  },
  "paragraph-counter": {
    title: "Free Paragraph Counter — Count Paragraphs Online | Toolkno",
    description: "Count paragraphs in any text instantly. Useful for essays, blog drafts and structured writing. Free, no signup.",
    keywords: ["paragraph counter", "count paragraphs", "paragraph count tool"]
  },
  "case-converter": {
    title: "Free Case Converter — UPPER, lower, Title, Sentence | Toolkno",
    description: "Convert text between UPPERCASE, lowercase, Title Case, Sentence case and tOGGLE in one click. Free, no signup.",
    keywords: ["case converter", "text case converter", "change case online"]
  },
  "text-to-uppercase-converter": {
    title: "Free Uppercase Converter — Make Text ALL CAPS | Toolkno",
    description: "Convert any text to ALL CAPS instantly. Great for headings, labels and stand-out social posts. Free, no signup.",
    keywords: ["uppercase converter", "all caps converter", "text to uppercase"]
  },
  "text-to-lowercase-converter": {
    title: "Free Lowercase Converter — Make Text All Lowercase | Toolkno",
    description: "Convert text to clean lowercase instantly. Useful for emails, slugs, URLs and tidy CSV data. Free, no signup.",
    keywords: ["lowercase converter", "text to lowercase", "all lowercase tool"]
  },
  "title-case-converter": {
    title: "Free Title Case Converter — Headlines & Blog Titles | Toolkno",
    description: "Turn any sentence into a clean title case headline. Great for blog titles, video titles and product names. Free, no signup.",
    keywords: ["title case converter", "headline case tool", "blog title formatter"]
  },
  "sentence-case-converter": {
    title: "Free Sentence Case Converter — Clean & Readable Text | Toolkno",
    description: "Convert messy or all-caps text into proper sentence case. Free, instant, no signup.",
    keywords: ["sentence case converter", "sentence case tool", "text formatter"]
  },
  "toggle-case-converter": {
    title: "Free Toggle Case Converter — Flip Upper & Lower | Toolkno",
    description: "Flip uppercase letters to lowercase and vice versa in one click. Free, no signup.",
    keywords: ["toggle case converter", "flip case tool", "invert case"]
  },
  "remove-extra-spaces": {
    title: "Free Remove Extra Spaces — Clean Whitespace Online | Toolkno",
    description: "Remove double spaces and trim messy whitespace from any text in one click. Free, no signup.",
    keywords: ["remove extra spaces", "trim whitespace", "clean spaces tool"]
  },
  "remove-line-breaks": {
    title: "Free Remove Line Breaks — Convert to Single Line | Toolkno",
    description: "Remove all line breaks and turn multi-line text into one clean single line. Free, no signup.",
    keywords: ["remove line breaks", "strip newlines", "single line text tool"]
  },
  "remove-duplicate-lines": {
    title: "Free Duplicate Line Remover — Dedupe Any List | Toolkno",
    description: "Remove duplicate lines from any list in one click. Great for emails, slugs, keywords or CSV exports. Free, no signup.",
    keywords: ["remove duplicate lines", "dedupe list online", "duplicate line remover"]
  },
  "remove-special-characters": {
    title: "Free Special Character Remover — Clean Text Online | Toolkno",
    description: "Strip punctuation, symbols and special characters from text instantly. Keep only letters and numbers. Free, no signup.",
    keywords: ["remove special characters", "strip symbols from text", "clean text online"]
  },
  "remove-numbers-from-text": {
    title: "Free Remove Numbers from Text — Strip Digits | Toolkno",
    description: "Remove all numbers from any text in one click. Useful for cleaning lists, content edits and writing tasks. Free, no signup.",
    keywords: ["remove numbers from text", "strip digits", "delete numbers in text"]
  },
  "remove-punctuation": {
    title: "Free Remove Punctuation — Clean Plain Text | Toolkno",
    description: "Remove all punctuation marks from any text in one click. Great for writing exercises and clean exports. Free, no signup.",
    keywords: ["remove punctuation", "strip punctuation", "punctuation remover online"]
  },
  "remove-emojis": {
    title: "Free Emoji Remover — Strip Emojis from Text | Toolkno",
    description: "Remove all emojis from text in one click. Clean up captions, chat exports or copy before publishing. Free, no signup.",
    keywords: ["remove emojis", "strip emojis", "emoji remover online"]
  },
  "remove-html-tags": {
    title: "Free HTML Tag Remover — Strip HTML to Plain Text | Toolkno",
    description: "Remove all HTML tags and keep only the readable text. Useful when copying from CMS, email or web pages. Free, no signup.",
    keywords: ["remove html tags", "strip html", "html to plain text"]
  },
  "remove-urls-from-text": {
    title: "Free Remove URLs from Text — Strip Links Online | Toolkno",
    description: "Remove all website links from any text in one click. Great for cleaning up posts, captions and copy. Free, no signup.",
    keywords: ["remove urls from text", "strip links", "delete urls online"]
  },
  "remove-email-addresses-from-text": {
    title: "Free Remove Email Addresses from Text | Toolkno",
    description: "Strip email addresses from any block of text in one click. Clean up logs, copies or shared notes before sharing. Free, no signup.",
    keywords: ["remove email addresses", "strip emails from text", "email scrubber online"]
  },
  "remove-accents": {
    title: "Free Accent Remover — Convert é to e Online | Toolkno",
    description: "Convert accented characters (é, ñ, ü) to plain English letters in one click. Free, no signup, works in your browser.",
    keywords: ["remove accents", "diacritic remover", "accent to plain letter"]
  },
  "text-sorter-a-z": {
    title: "Free Text Sorter A-Z — Sort Lines Alphabetically | Toolkno",
    description: "Sort any list of lines alphabetically A-Z in one click. Useful for cleaning lists, names and keywords. Free, no signup.",
    keywords: ["text sorter a-z", "alphabetical sort online", "sort lines a to z"]
  },
  "text-sorter-z-a": {
    title: "Free Text Sorter Z-A — Reverse Alphabetical Sort | Toolkno",
    description: "Sort lines in reverse alphabetical order Z-A in one click. Free online text sorter, no signup.",
    keywords: ["text sorter z-a", "reverse alphabetical sort", "sort lines z to a"]
  },
  "reverse-text": {
    title: "Free Reverse Text Tool — Backwards Text Online | Toolkno",
    description: "Reverse any text character by character in one click. Fun for puzzles, codes and quick string flips. Free, no signup.",
    keywords: ["reverse text", "backwards text generator", "flip text online"]
  },
  "reverse-words": {
    title: "Free Reverse Words Tool — Flip Word Order | Toolkno",
    description: "Reverse the order of words in any sentence in one click. Useful for headline brainstorms and writing exercises. Free, no signup.",
    keywords: ["reverse words", "flip word order", "reverse word order online"]
  },
  "reverse-lines": {
    title: "Free Reverse Lines Tool — Flip Line Order | Toolkno",
    description: "Flip the order of lines in any list in one click. Great for reversing chronological lists or logs. Free, no signup.",
    keywords: ["reverse lines", "flip line order", "reverse list online"]
  },
  "text-splitter": {
    title: "Free Text Splitter — Split by Comma, Space or Line | Toolkno",
    description: "Split text into separate lines using commas, spaces or any delimiter in one click. Free, no signup.",
    keywords: ["text splitter", "split text by delimiter", "split text into lines"]
  },
  "line-splitter": {
    title: "Free Line Splitter — Format Text into Clean Lines | Toolkno",
    description: "Split a block of text into clean separate lines in one click. Great for prepping lists and bullet points. Free, no signup.",
    keywords: ["line splitter", "split text into lines", "line formatter online"]
  },
  "word-splitter": {
    title: "Free Word Splitter — Separate Each Word | Toolkno",
    description: "Split text into individual words on separate lines in one click. Great for vocab lists and word study. Free, no signup.",
    keywords: ["word splitter", "split text into words", "separate words online"]
  },
  "paragraph-splitter": {
    title: "Free Paragraph Splitter — Break Long Text Apart | Toolkno",
    description: "Split a wall of text into clean paragraphs in one click. Useful for editing and reformatting long copy. Free, no signup.",
    keywords: ["paragraph splitter", "split into paragraphs", "break text into paragraphs"]
  },
  "combine-text-lines": {
    title: "Free Combine Lines — Merge Lines into One | Toolkno",
    description: "Merge multiple lines into one single line with a separator of your choice. Free, instant, no signup.",
    keywords: ["combine lines", "merge lines into one", "join lines online"]
  },
  "text-joiner": {
    title: "Free Text Joiner — Join Lines with Custom Separator | Toolkno",
    description: "Join multiple lines using a comma, pipe or any custom separator in one click. Free, no signup.",
    keywords: ["text joiner", "join lines with separator", "merge text online"]
  },
  "lorem-ipsum-generator": {
    title: "Free Lorem Ipsum Generator — Placeholder Text | Toolkno",
    description: "Generate Lorem Ipsum placeholder text for websites, designs and mockups in one click. Free, no signup.",
    keywords: ["lorem ipsum generator", "placeholder text generator", "dummy text online"]
  },
  "random-word-generator": {
    title: "Free Random Word Generator — Brainstorm & Test | Toolkno",
    description: "Generate random words for writing prompts, brainstorming and form testing. Free, no signup.",
    keywords: ["random word generator", "word generator online", "brainstorm words"]
  },
  "random-sentence-generator": {
    title: "Free Random Sentence Generator — Writing Prompts | Toolkno",
    description: "Generate random sentences for writing practice, layout testing and creative prompts. Free, no signup.",
    keywords: ["random sentence generator", "sentence generator online", "writing prompts"]
  },
  "random-paragraph-generator": {
    title: "Free Random Paragraph Generator — Mockups & Layouts | Toolkno",
    description: "Generate random paragraphs for design mockups, wireframes and content testing. Free, no signup.",
    keywords: ["random paragraph generator", "paragraph generator online", "mockup text"]
  },
  "prefix-suffix-text-generator": {
    title: "Free Prefix Suffix Generator — Add to Every Line | Toolkno",
    description: "Add a custom prefix or suffix to every line of text in one click. Great for lists, slugs and bulk formatting. Free, no signup.",
    keywords: ["prefix suffix generator", "add prefix to lines", "bulk text formatter"]
  },
  "text-compare-tool": {
    title: "Free Text Compare Tool — Find Differences Online | Toolkno",
    description: "Compare two texts side by side and spot every difference in seconds. Free online text compare, no signup.",
    keywords: ["text compare tool", "compare two texts", "text diff online"]
  },
  "text-difference-checker": {
    title: "Free Text Difference Checker — See What Changed | Toolkno",
    description: "Check if two texts contain any differences and see exactly what changed. Free, no signup.",
    keywords: ["text difference checker", "text diff", "compare text changes"]
  },
  "case-sensitive-compare": {
    title: "Free Case-Sensitive Compare — Exact Match Check | Toolkno",
    description: "Compare two texts with exact case sensitivity. Useful for codes, passwords and strict matches. Free, no signup.",
    keywords: ["case sensitive compare", "exact text match", "strict text compare"]
  },
  "case-insensitive-compare": {
    title: "Free Case-Insensitive Compare — Ignore Upper/Lower | Toolkno",
    description: "Compare two texts while ignoring uppercase and lowercase differences. Free, no signup.",
    keywords: ["case insensitive compare", "ignore case compare", "text match no case"]
  },
  "keyword-density-checker": {
    title: "Free Keyword Density Checker — SEO Tool Online | Toolkno",
    description: "Check keyword frequency and density in your content for better on-page SEO. Free, no signup.",
    keywords: ["keyword density checker", "seo keyword tool", "on-page keyword analyzer"]
  },
  "stop-word-counter": {
    title: "Free Stop Word Counter — Find Filler Words | Toolkno",
    description: "Count common stop words like 'the', 'and', 'is' in your text. Spot filler and tighten your writing. Free, no signup.",
    keywords: ["stop word counter", "filler word counter", "find stop words"]
  },
  "readability-checker": {
    title: "Free Readability Checker — Flesch Score Online | Toolkno",
    description: "Check how easy your text is to read with Flesch reading ease scores. Free online readability checker, no signup.",
    keywords: ["readability checker", "flesch reading ease", "readability score tool"]
  },
  "sentence-analyzer": {
    title: "Free Sentence Analyzer — Length & Structure | Toolkno",
    description: "Analyze sentence length and structure to spot run-ons and improve flow. Free, no signup.",
    keywords: ["sentence analyzer", "sentence length tool", "writing analyzer"]
  },
  "text-complexity-analyzer": {
    title: "Free Text Complexity Analyzer — Vocab & Depth | Toolkno",
    description: "Analyze vocabulary depth and sentence complexity in your writing. Free online tool, no signup.",
    keywords: ["text complexity analyzer", "vocabulary checker", "writing complexity tool"]
  },
  "text-masking-tool": {
    title: "Free Text Masking Tool — Hide Sensitive Parts | Toolkno",
    description: "Mask sensitive parts of text by replacing them with symbols. Useful before sharing screenshots or logs. Free, no signup.",
    keywords: ["text masking tool", "mask sensitive text", "hide text online"]
  },
  "text-redaction-tool": {
    title: "Free Text Redaction Tool — Blackout Sensitive Info | Toolkno",
    description: "Redact sensitive information from text with blackout placeholders. Free, no signup, runs in your browser.",
    keywords: ["text redaction tool", "redact text online", "blackout text"]
  },
  "censor-text-tool": {
    title: "Free Censor Text Tool — Bleep Out Words | Toolkno",
    description: "Censor specific words from text while keeping the structure readable. Free, no signup.",
    keywords: ["censor text tool", "bleep words", "censor word filter"]
  },
  "normalize-unicode-text": {
    title: "Free Unicode Normalizer — Fix Weird Characters | Toolkno",
    description: "Normalize Unicode text into a clean, consistent format across systems. Fix weird characters in copied text. Free, no signup.",
    keywords: ["unicode normalizer", "fix unicode characters", "normalize text online"]
  },
  "find-and-replace-text": {
    title: "Free Find and Replace Online — Bulk Edit Text | Toolkno",
    description: "Find specific words and replace them with new text in one click. Great for bulk edits and writing fixes. Free, no signup.",
    keywords: ["find and replace text", "bulk replace online", "text find replace"]
  },
  "text-randomizer": {
    title: "Free Text Randomizer — Shuffle Word Order | Toolkno",
    description: "Shuffle and randomize the order of words in any text. Free, no signup.",
    keywords: ["text randomizer", "shuffle words", "randomize word order"]
  },
  "shuffle-text-lines": {
    title: "Free Shuffle Text Lines — Randomize Line Order | Toolkno",
    description: "Randomly shuffle the order of lines in any list. Useful for surveys, draws and random sampling. Free, no signup.",
    keywords: ["shuffle text lines", "randomize lines", "shuffle list online"]
  },
  "text-tokenizer": {
    title: "Free Text Tokenizer — Split Text into Tokens | Toolkno",
    description: "Split text into individual tokens for structured analysis. Free, no signup.",
    keywords: ["text tokenizer", "tokenize text online", "word tokenizer"]
  },
  "text-validator": {
    title: "Free Text Validator — Check Format & Rules | Toolkno",
    description: "Validate text against basic formatting and content rules in one click. Free, no signup.",
    keywords: ["text validator", "validate text online", "text format checker"]
  },
  "text-to-speech": {
    title: "Free Text to Speech — Read Text Aloud Online | Toolkno",
    description: "Turn any text into spoken audio right in your browser. Great for proofreading and accessibility. Free, no signup.",
    keywords: ["text to speech", "read text aloud", "tts online free"]
  },
  "speech-to-text": {
    title: "Free Speech to Text — Voice to Text Online | Toolkno",
    description: "Convert speech into written text right in your browser. Great for quick notes and dictation. Free, no signup.",
    keywords: ["speech to text", "voice to text", "dictation online free"]
  },
  "text-to-binary-converter": {
    title: "Free Text to Binary Converter — Encode in Binary | Toolkno",
    description: "Convert any text into 8-bit binary code in one click. Great for learning, debugging and fun puzzles. Free, no signup.",
    keywords: ["text to binary", "binary encoder", "text to binary converter"]
  },
  "binary-to-text-converter": {
    title: "Free Binary to Text Converter — Decode Binary | Toolkno",
    description: "Decode binary numbers into readable text in one click. Free online binary to text converter, no signup.",
    keywords: ["binary to text", "binary decoder", "binary to text converter"]
  },
  "text-to-ascii-converter": {
    title: "Free Text to ASCII Converter — Decimal Codes | Toolkno",
    description: "Convert any text into decimal ASCII character codes in one click. Free, no signup.",
    keywords: ["text to ascii", "ascii converter", "text to ascii codes"]
  }
};
...
export { stopWords, titleFromSlug };
